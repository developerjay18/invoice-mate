  ...
  <Document>
    ...
    >
      ...
      <View style={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          <Text style={{ borderBottom: "1px solid red", padding: "5px" }}>
            Delivery At : {props.deliveryAt}
          </Text>
          <Text style={{ fontSize: "10px", padding: "5px" }}>
            Notice: Consignments Covered by this set to special Lorry Receipt
            From shall be stored at the destination under the control of the
            Transport Operator and shall delivery to or to order of the
            consignee bank whose name is maintained in the receipt it will under
            not circumstances delivered without the written authority from the
            consignee bank or its order ensodes on the consignee copy or a
            separate US authority.
          </Text>
        </View>
        ...
        >
          ...
          <Text
            style={{ fontSize: "10px", textAlign: "center", padding: "3px" }}
          >
            The Customer has arated that The has Insured the consignment of he
            has insured the consignment Company.
          </Text>

          <View style={{ fontSize: "10px", width: "100%", padding: "5px" }}>
            {/* fisrt-row  */}
            <View style={{ display: "flex", flexDirection: "row", gap: "7px" }}>
              <View
                style={{
                  width: "50%",
                  display: "flex",
              ...
              >
                ...
                <Text
                  style={{ width: "50%", borderBottom: "1px dotted red" }}
                ></Text>
              </View>
              ...
              >
                ...
                <Text
                  style={{ width: "75%", borderBottom: "1px dotted red" }}
                ></Text>
              </View>
            </View>
        ...
        >
          <Text style={{ padding: "10px 5px", borderBottom: "1px solid red" }}>
            C/N {props.lrNum}
          </Text>
          <Text style={{ padding: "10px 5px", borderBottom: "1px solid red" }}>
            Date: {props.date}
      ...
      <View style={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          <Text style={{ padding: "14px 5px" }}>From: {props.from}</Text>
          <Text style={{ padding: "14px 5px" }}>To: {props.to}</Text>
        </View>
      </View>
      {/* column 4 */}
      <View
      ...
      >
        ...
        >
          ...
          <View
            style={{ display: "flex", flexDirection: "row", fontSize: "10px" }}
          >
            <Text
              style={{
                width: "50%",
            ...
            <Text style={{ width: "50%", padding: "3px" }}>Charge Kg Grm</Text>
          </View>
        </View>
        <Text
          style={{
        ...
        >
          ...
          <View
            style={{ fontSize: "10px", display: "flex", flexDirection: "row" }}
          >
            <Text
              style={{
                width: "50%",
            ...
            <Text style={{ width: "50%", textAlign: "center", padding: "3px" }}>
              To Pay Rs.ps
            </Text>
          </View>
        </View>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={{ width: "50%", padding: "3px" }}></Text>
          </View>
      ...
      {/* column 6  */}
      <View style={{ display: "flex", flexDirection: "row", fontSize: "7px" }}>
        <View
          style={{
            width: "30%",
            border: "1px solid red",
        ...
        >
          <Text style={{ padding: "3px 0" }}>
            ...
            Consignee / Consignor Cenvet credit has not been taken on duty paid
            on inputs and/or capital goods used for providing this
        ...
        >
          <Text>Not Responsible for Leakage or Breakage Booking Office</Text>
        </View>
      </View>
    </Page>
  </Document>
